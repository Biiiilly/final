...
// Module: Final.Basic
// Imports: Init Mathlib.Analysis.Normed.Ring.Seminorm Mathlib.Analysis.SpecialFunctions.Pow.Real
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Final_Basic(uint8_t builtin, lean_object* w) {
lean_object * res;
